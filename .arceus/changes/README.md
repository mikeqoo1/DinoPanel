...
| `v0.6.1-supervisor-disk-denoise`            | active     | v0.6.1  | Supervisor = systemd .service management (4th toolbox tab; list/status + start/stop/restart/enable/disable; tiered protected-units guard) + disk-table de-noise (`df -PTB1` fstype filter, default-hide overlay/pseudo + toggle). Stateless. supervisord + swap-write NOT in this cut |
