...
import { LayoutDashboard, Terminal, FolderOpen, Settings, Settings2, ChevronLeft, Container, Layers, Network, HardDrive, Workflow, Activity, Globe, Database, Archive, Wrench, Server, Boxes } from 'lucide-react';
...
export function Sidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  const items = [
    ...
    { to: '/toolbox', icon: Wrench, label: t('nav.toolbox') },
    { to: '/nodes', icon: Server, label: t('nav.nodes') },
    { to: '/nexus', icon: Boxes, label: t('nav.nexus') },
